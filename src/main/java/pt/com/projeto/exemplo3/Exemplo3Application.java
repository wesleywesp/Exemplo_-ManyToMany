package pt.com.projeto.exemplo3;
...
import pt.com.projeto.exemplo3.repositorio.AlunosRepositorios;
import pt.com.projeto.exemplo3.repositorio.CursoRepositorio;
...
public class Exemplo3Application {
	...
	@Bean
public CommandLineRunner mappingDemo(AlunosRepositorios ar, CursoRepositorio cr) {
    return args -> {
